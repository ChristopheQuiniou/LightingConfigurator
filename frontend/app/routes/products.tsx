...
import { ProductCategories, type Product } from "~/features/product/productType";
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const {data,error} = await getProduct(options);
...
export default function Products({ loaderData }: Route.ComponentProps) {
  ...
  const handleReset = (e: FormEvent<HTMLButtonElement>) => {
    ...
    // Re-run the loader with no search params
    submit(new FormData(), { method: "get", action: "/products", replace: true });
  };
